...
export const NL: LanguageAliases = {
  ...
  cup: ['kopje', 'kopjes'],
  piece: ['stuk', 'stuks'],
  pinch: ['snuf', 'snufje', 'snufjes'],
  clove: ['teen', 'teentje', 'teentjes'],
  handful: ['handje', 'handjevol', 'handjes'],
  can: ['blik', 'blikje', 'blikken', 'blikjes'],
  packet: ['pak', 'pakken', 'pakje', 'pakjes'],
  bag: ['zakje', 'zakjes'],
  // `dozen` is left out on purpose: it is also the English word for twelve.
  box: ['doos'],
  sprig: ['takje', 'takjes'],
  leaf: ['blad', 'bladeren', 'blaadjes', 'blaadje'],
  slice: ['plak', 'plakje', 'plakjes', 'schijf', 'schijfje', 'schijfjes'],
  bottle: ['fles', 'flessen'],
  jar: ['pot', 'potten', 'potje', 'potjes'],
  bunch: ['bosje', 'bosjes'],
  stalk: ['steel', 'stelen', 'stengel', 'stengels'],
  head: ['krop', 'kroppen'],
  sheet: ['vel', 'vellen'],
  drop: ['druppel', 'druppels'],
  dash: ['scheutje', 'scheutjes', 'scheut'],
  cube: ['blokje', 'blokjes'],
  knob: ['klontje', 'klontjes'],
};
